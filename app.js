...
class GlimmerMap extends Component {
    ...
    renderText() {
        var divText = this.element.querySelector("#textDiv");
        divText.innerHTML = "This is a sample web component built using Glimmer";
    }
    sampleAction() {
        this.element.querySelector("#textDiv").innerHTML = "Value Changed";
    }
}
__decorate([tracked], GlimmerMap.prototype, "val", void 0);

var __ui_components_GlimmerMap_template__ = { "id": "aS5woVUG", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[10,\"class\",\"glimmer-map\"],[8],[0,\"\\n\\t\"],[6,\"h1\"],[8],[0,\"Welcome to Glimmer!\"],[9],[0,\"\\n\\t\"],[6,\"div\"],[10,\"id\",\"textDiv\"],[8],[9],[0,\"\\n\\t\"],[6,\"input\"],[10,\"id\",\"textBox\"],[11,\"value\",[20,\"val\"],null],[11,\"oninput\",[26,\"action\",[[22,[\"sampleAction\"]]],null],null],[8],[9],[0,\"\\n\\t\"],[6,\"div\"],[10,\"id\",\"textValue\"],[8],[1,[20,\"val\"],false],[9],[0,\"\\n\"],[9]],\"hasEval\":false}", "meta": { "specifier": "template:/glimmer-map/components/GlimmerMap" } };

var moduleMap = { 'component:/glimmer-map/components/GlimmerMap': GlimmerMap, 'template:/glimmer-map/components/GlimmerMap': __ui_components_GlimmerMap_template__ };
...
app.renderComponent('GlimmerMap', containerElement, null);
app.boot();
initializeCustomElements(app, { 'glimmer-map': 'GlimmerMap' });
